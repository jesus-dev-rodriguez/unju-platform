...
| :---------------------------------: | :----------------------------------: |
| _[Screenshot o descripción actual]_ | _[Link a Figma o descripción nueva]_ |
...
- [ ] **Feature Flag:** ¿Es necesario ocultar esto tras una _flag_ hasta que esté 100% listo? (Sí/No)
